        ...
        <div class="container-fluid">
            ...
            <section id="welcome" class="tm-content-box tm-banner margin-b-10">
                <div class="tm-banner-inner">
                    <h1 class="tm-banner-title">OUR SOCIETY</h1>                        
                </div>                    
            </section>
            ...
            <div class="tm-body">
                    ...
                    <nav class="tm-main-nav">
                        <ul class="tm-main-nav-ul">
                            <li class="tm-nav-item"><a href="#welcome" class="tm-nav-item-link tm-button">
                                <i class="fa fa-smile-o tm-nav-fa"></i>Key People</a>
                            </li>
                            ...
                            <li class="tm-nav-item"><a href="#services" class="tm-nav-item-link tm-button">
                                <i class="fa fa-tasks tm-nav-fa"></i>Our Events</a>
                            </li>
                            <li class="tm-nav-item"><a href="#about" class="tm-nav-item-link tm-button">
                                <i class="fa fa-sitemap tm-nav-fa"></i>About</a>
                            </li>
                            <li class="tm-nav-item"><a href="#contact" class="tm-nav-item-link tm-button">
                                <i class="fa fa-envelope-o tm-nav-fa"></i>Contact Us</a>
                            </li>
							 <li class="tm-nav-item"><a href="iemsb/index.html" class="tm-nav-item-link tm-button">
                                <i class="fa fa-home tm-nav-fa"></i>Home</a>
                            </li>
                        </ul>
                    </nav>
                </div>
                ...
                <div class="tm-main-content">
                    ...
                    <div class="tm-content-box tm-content-box-home">                        
                        ...
                        <div class="tm-welcome-boxes-container">
                            <div class="tm-welcome-box">
								...
								<img src="img/1200x800-01.jpg" class="img-fluid img-resonsive">									
                                </div>                            
                                <a  class="tm-welcome-link tm-button">Person1 | Faculty advisor</a>
                            </div>
                            <div class="tm-welcome-box">
                                <div class="tm-welcome-text">
                                    <img src="img/1200x800-01.jpg" class="img-fluid img-resonsive">
                                </div>                            
                                <a  class="tm-welcome-link tm-button">Person2 | Chair Person</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="gallery" class="tm-content-box">                        
                        <div class="grid tm-gallery">
                            ...
                            <figure class="effect-bubba">
                                ...
                                <figcaption>
                                   <a href="img/img-11-06.jpg">View more</a>
                                 </figcaption>
                            </figure>
                    ...
                    <div id="services" class="tm-content-box tm-gray-bg tm-services">
						...
						<div class="row">
                            <h2 class="tm-section-title">Our Event 1</h2>
                            <p class="tm-section-description">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
						</div>
						<div class="row">	
							<h2 class="tm-section-title">Our Event 1</h2>
							<p class="tm-section-description">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p> 
                    ...
                    <div id="about" class="tm-content-box">
                        <div class="tm-box-pad tm-bordered-box">
                            <h2 class="tm-section-title">About Our Society</h2>
                        ...
                        <div class="tm-flex">
                            <div class="tm-purple-bg tm-box-pad tm-bordered-box tm-no-border-top">
                                <h2 class="tm-section-title">Faculty Advisor</h2>
                                <p>some texts here</p>
                            </div>
                            <div class="tm-gray-bg tm-box-pad tm-bordered-box tm-no-border-top">
                                <h2 class="tm-section-title">Chair Person</h2>
                                <p>some texts here</p>
                            </div>    
                        </div>                        
                    </div>
                            ...
                            <div class="tm-contact-left-half tm-gray-bg">
                                <div class="tm-contact-inner-pad">
                                    ...
                                    <form action="index.php" method="post" class="contact-form">
                                        ...
                                        <div class="form-group">
                                            <input type="email" id="contact_email" name="_email" class="form-control" placeholder="Email"  required>
                                        </div>
										 <div class="form-group">
                                            <input type="text" id="contact_phone" name="phone" class="form-control"  placeholder="phone" required>
                                        </div>
                                        <div class="form-group">
                                            <textarea id="contact_message" name="msg" class="form-control" rows="9" placeholder="Message" required></textarea>
                                        </div>
										
                                        
                                        <button type="submit" name="submit" class="btn btn-primary pull-xs-right tm-button tm-button-normal">Submit</button>
...
?>
                            ...
                            <div class="tm-contact-right-half tm-purple-bg">
                                <div class="tm-address-box">
                                    ...
                                    <address>IEM Gurukul building<br>
                                             college more<br>
                                             Salt lake sector V
                                    </address>    
                                </div>                                
                    ...
                    <footer class="tm-footer">
                        <p class="text-xs-center">Copyright &copy; All rights reserved to IEEE IEM STUDENTS BRANCH</p>
                    </footer>
